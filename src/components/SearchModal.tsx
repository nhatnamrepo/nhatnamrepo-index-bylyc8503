...
return (
  <Transition appear show={searchOpen} as={Fragment}>
    <Dialog as="div" className="fixed inset-0 z-[200] overflow-y-auto" onClose={closeSearchBox}>
      <div className="min-h-screen px-4 pt-12 text-center">
        <Transition.Child
          as={Fragment}
        ...
        >
          <div className="inline-block w-full max-w-3xl overflow-hidden rounded border border-gray-300/30 text-left shadow-xl backdrop-blur-lg">
            <Dialog.Title
                as="h3"
