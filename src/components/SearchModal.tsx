...
function SearchResultItemTemplate({
  ...
  return (
    <Link
      href={driveItemPath}
      passHref
      className={`flex items-center space-x-4 border-b border-gray-400/30 px-4 py-1.5 hover:bg-white/10 ${disabled ? 'pointer-events-none cursor-not-allowed' : 'cursor-pointer'
        }`}
    >
        ...
        <div className="fixed inset-0 overflow-y-auto pointer-events-none">
          <div className="flex min-h-full items-center justify-center p-4">
            <div className="pointer-events-none w-full max-w-3xl">
              ...
              >
                <div className="overflow-hidden rounded-3xl border border-gray-300/30 text-left shadow-[0_0_30px_rgba(255,255,255,0.25)] backdrop-blur-lg">
                  <Dialog.Title
                    as="h3"
                  ...
                  >
                    ...
                    <input
                      type="text"
                      id="search-box"
                      className="w-full bg-transparent text-center focus:outline-none focus-visible:outline-none"
                      placeholder={'Search ...'}
                      value={query}
