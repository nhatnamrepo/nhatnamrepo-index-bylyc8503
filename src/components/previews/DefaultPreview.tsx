          ...
          <div className="flex flex-col space-y-2 py-4 md:flex-1">
            ...
            <div>
              ...
              <table className="block w-full overflow-scroll whitespace-nowrap text-sm md:table">
                <tbody>
                  <tr className="border-y bg-gray-900/60 dark:border-gray-700 dark:bg-gray-900">
                    <td className="bg-gray-800/60 px-3 py-1 text-left text-xs font-medium uppercase tracking-wider text-gray-200 dark:bg-gray-800 dark:text-gray-400">
                      Quick XOR
                    </td>
                    <td className="whitespace-nowrap px-3 py-1 font-mono text-gray-300 dark:text-gray-400">
